...
const ServiceForm = () => {
  ...
  return (
    <div className="px-20 py-10 w-full h-full flex flex-row bg-[#CADEC8] text-[#080D0E]">
      <div className="w-full h-full flex flex-row border-[15px] rounded-[75px] border-[#080D0E]">
        ...
        <div className="w-1/2 h-full pl-[2.5rem] flex flex-col bg-[#EEEAE3] rounded-r-[65px]">
